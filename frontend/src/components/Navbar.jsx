...
const Navbar = () => {
    ...
    // here  we are adding functionality for removing the token when logout 
    const logout=()=>{
        navigate('/login')
...
{/* -----------------Center part of the Navbar-------------------  */}
            ...
            <div className='flex item-center gap-6 '>
                ...
                <div className='group relative '>
                    ...
                    {/* making the profile icon the linkable tag to rediect to the login-page   */}
...
{/* ---------CART-------- */}
                <Link to='/cart' className='relative '>
                    ...
                    <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center bg-black text-white aspect-square rounded-full text-[10px]  leading-4  '>
                        {getCartCount()}
                    </p>
...
{/* Sidebar  */}
            ...
            {/*   we are creating the sidebar for small screen  when visible  is true then the sidebar  will show  */}
            {/* using overflow-hidden because we do not want to show the scrollbar on that div  */}
